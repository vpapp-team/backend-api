...
exports.onRequest = (req, resp, subpath, locationLOADER, { version, platform, userAgent }) => {
  ...
  if (typeof location.dir === 'string') {
    return location.get('Index').onRequest(req, resp, subpath, location, { version, platform, userAgent });
  } else { return location.onRequest(req, resp, subpath, location, { version, platform, userAgent }); }
};
